# -*- coding: utf-8 -*-
#
# SVGSchematic documentation build configuration file, created by
...
htmlhelp_basename = 'svg_schematic'
...
latex_documents = [
  ('index', 'svg_schematic.tex', u'SVG Schematic Documentation',
...
man_pages = [
    ('index', 'svg_schematic', u'SVG-Schematic Documentation',
     [u'Ken Kundert'], 1)
]
...
texinfo_documents = [
  ('index', 'SVGSchematic', u'SVG Schematic Documentation',
   u'Ken Kundert', 'SVGSchematic', 'One line description of project.',
   'Miscellaneous'),
]
